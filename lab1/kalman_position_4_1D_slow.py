...
raw_measurements_accel, raw_measurements_gyro = extract_values_from_file("/Users/egeturan/Documents/Sensing/SmartphoneSensors292S/ee292s/lab1/oct23/6ft_slow_round_straight")
...
for t in range(num_samples):
    z = -1*raw_accel[t][0]  # Use the X-axis acceleration in world frame
    ...
    # kf.x[1] = kf.x[1]*0.97 if (np.abs(kf.x[1]) < 0.05) else kf.x[1] # prevent end drift by damping of velocity
